...
- `scripts/` — Python (uv) one-off maintenance scripts, run by hand rather than as part of a build, e.g. [optimizing Figma-exported SVG animations](scripts/README.md)
